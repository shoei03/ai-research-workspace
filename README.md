...
├── slidegen/drafts/       # ゼミ・輪講用スライド draft (markdown)
└── log.md                 # 作業履歴
```
...
| .gitkeep (ディレクトリ構造) | raw/papers/*.pdf, log.md, slidegen/drafts/* |
